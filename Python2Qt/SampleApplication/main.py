...
appDataPath = os.environ["HOME"] + os.path.sep + __appname__ +os.path.sep
...
logging.basicConfig(filename=appDataPath + "SampleApplication.log",
...
class Main(QMainWindow, pyMainWindow.Ui_mainWindow):
    ...
    dbPath = appDataPath + "sample_application.db"
    ...
    def __init__(self, parent=None):
        ...
        self.settings = QSettings(QSettings.NativeFormat, QSettings.UserScope, "SampleApplication", "SampleApplication")
    ...
    def validate_fields(self):
        ...
        if not re.match('^[29]\d{2}-\d{3}-\d{4}', self.phoneNumber.text()):
    ...
    def export_action_triggered(self):
        ...
        dbFile = QFileDialog.getSaveFileName(parent=None, caption="Export database to a file", directory=".", filter="SampleApplication  CSV (*.csv)")
...
def main():
    QCoreApplication.setApplicationName("SampleApplication")
    QCoreApplication.setApplicationVersion("0.1")
    QCoreApplication.setOrganizationName("SampleApplication")
    QCoreApplication.setOrganizationDomain("SampleApplication.com")
